...
setenv CNIPOL_DIR /star/u/xchu/run24/cnipol
#setenv CNIPOL_DATA_DIR /gpfs02/eic/cnipol/run$RUN_ID/data
#setenv CNIPOL_RESULTS_DIR /gpfs02/eic/cnipol/run$RUN_ID/root
#setenv CNIPOL_DATA_DIR /gpfs02/eic/cnipol/xchu/run$RUN_ID/data
#setenv CNIPOL_DATA_DIR /gpfs02/eic/cnipol/xchu/run$RUN_ID/root
setenv CNIPOL_DATA_DIR /gpfs01/star/scratch/xchu/run$RUN_ID/data
setenv CNIPOL_RESULTS_DIR /gpfs01/star/scratch/xchu/run$RUN_ID/root
